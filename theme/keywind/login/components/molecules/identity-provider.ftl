    ...
    <#list providers as provider>
      ...
      >
        <#if providerIcons[provider.alias]??>
          ...
          <div class="h-6 w-6" style="margin-left: 0.375rem;">
